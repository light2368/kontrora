...
window.KONTRORA_SEARCH_INDEX = [
  ...
  },
  {
    title: 'Features',
    url: '/features',
    snippet: 'Capacity planning, time tracking, visual workflow builder, client portal, RBAC, project analytics. Everything your agency needs in one platform.',
    keywords: 'features capacity time tracking workflow client portal rbac analytics projects'
  },
  {
    title: 'Pricing',
    url: '/pricing',
  ...
  },
  {
    title: 'Roadmap',
    url: '/roadmap',
    snippet: 'See what we are building next. Analytics enhancements, branded client portals, revenue tracking, AI-assisted capacity recommendations.',
    keywords: 'roadmap future features upcoming planned development'
  },
  {
    title: 'About',
    url: '/about',
  ...
  },
  {
    title: 'Time Tracking',
    url: '/features',
    snippet: 'Built-in time tracking with timers, manual entry, and admin analytics. Track billable hours across all projects.',
    keywords: 'time tracking timers billable hours logging'
  },
  {
    title: 'Client Portal',
    url: '/features',
    snippet: 'Secure client portal with invite-based access. Give clients live visibility into their projects without exposing internal operations.',
    keywords: 'client portal access visibility projects approvals feedback'
  },
  {
    title: 'Workflow Builder',
    url: '/features',
    snippet: 'Visual workflow builder with enforced SOPs, audit trails, and automatic handoffs. Replace static documents with living processes.',
    keywords: 'workflow builder sop automation handoffs audit trail'
  },
  {
    title: 'GitHub',
